...
* и вручную или с помощью кнопки tab выбираем созданный файл и вводим команду в терминале git add example.md
* далее даем команду git чтобы он отслеживал данный файл на изменения: git commit -m "пометка", где -m дает возможность написать заметку в ковычках для понимания какой шаг выполнен
